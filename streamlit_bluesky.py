...
def predict(latitude_input,longitude_input,date):
    ...
    # #     #ds1=open(r"C:/Users/PRAMILA/.spyder-py3/project/data/L2/S5P_OFFL_L2__NO2____20210325T104955_20210325T123125_17863_01_010400_20210327T044257.nc", encoding="cp437", errors='ignore')
   ...
   # L3_data.to_netcdf(path=r"C:\Users\PRAMILA\.spyder-py3\project\data\combined.nc")
    L3_data1=Dataset(r"C:\Users\PRAMILA\.spyder-py3\project\data\combined.nc")
    ...
    # # def predict(latitude_input,longitude_input,date):
    # latitude_input=51.5352
    # longitude_input= 0.2121
    ...
    df.to_csv(r"C:\Users\PRAMILA\.spyder-py3\project\data\combined.csv")
    #print(os.path.getsize(r"C:\Usesrs\PRAMILA\.spyder-py3\project\data\2.csv"))
    
    ### Stock Market Prediction And Forecasting Using Stacked LSTM
    
    
    ### Data Collection
    data_frame=pd.read_csv(r"C:\Users\PRAMILA\.spyder-py3\project\data\combined.csv")
    ...
    model.summary()
    model.summary()
    model.fit(X_train,y_train,validation_data=(X_test,ytest),epochs=50,batch_size=2,verbose=1)
    ...
    # plt.plot(day_new,scaler.inverse_transform(df1[len(df1)-7:]))
...
with col1:
     latitude_input=st.text_input('🌡️ Minimum Temperature (°C)')                         
with col2:   
     longitude_input=st.text_input('🌡️ Maximum Temperature (°C)')                         
...
date = st.date_input('Start', value = pd.to_datetime('2021-04-14'),min_value= pd.to_datetime('2021-04-14'),max_value= pd.to_datetime('2021-04-30'))
